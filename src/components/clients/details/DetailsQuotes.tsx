...
import { useGetQuotesByUserIDQuery } from '@/redux/features/quotes/quoteApi';
...
export default function DetailsQuotes({ userID }: { userID: string }) {
    ...
    const { data, isLoading } = useGetQuotesByUserIDQuery(
        {
            userID,
            search: searchQuery,
            page: currentPage,
                    ...
                    <TableBody>
                        {isLoading ? (
                            ...
                            quotes
                                .filter(
                                    (quote: IQuote) =>
                                        quote.quoteStage === 'details-provided'
                                )
                                .map((quote: IQuote, index: number) => {
